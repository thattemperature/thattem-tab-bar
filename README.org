...
[[file:asserts/logo.svg]]

* 🌈 A Beautiful, Icon‑Driven Tab Bar for Emacs

*thattem‑tab‑bar* replaces Emacs’s default tab‑bar with a visually
...
- **Theme‑aware colors** – separate color sets for light and dark
  themes; everything is customizable.
- **Workspace integration** – show desktop workspaces (virtual
...
- **Mouse‑wheel support** – scroll over the tab bar to cycle through
  ...
  tabs quickly.
- **Customizable faces** – six different faces (normal, big,
...
The package defines eight color variables – four for light themes,
four for dark themes – that control the background and foreground of
...
- … and their dark‑theme counterparts.
...
- ~thattem‑tab‑bar/face‑1~, ~face‑2~ – used for “small” text (history
  arrows, align‑right spacer, etc.)
- ~thattem‑tab‑bar/big‑face‑1~, ~big‑face‑2~ – used for “big” text
...
Customize ~tab‑bar‑format~ after enabling ~thattem‑tab‑bar‑mode~.  The
